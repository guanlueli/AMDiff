...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_path', type=str, default= '/result/train_model1')
    parser.add_argument('--eval_step', type=int, default=-1)
    parser.add_argument('--eval_num_examples', type=int, default=None)
    parser.add_argument('--protein_root', type=str, default= 'data/crossdocked_v1.1_rmsd1.0_pocket10')
