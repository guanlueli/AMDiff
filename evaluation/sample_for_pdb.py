...
from datasets.data_load import pdb_to_pocket_data_ligand
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mol_path', type=str, default = './data/ALK/3lcs/3lcs_ligand.sdf')
    parser.add_argument('--device', type=str, default='cuda:0')
    parser.add_argument('--batch_size', type=int, default=20)
    parser.add_argument('--result_path', type=str, default= data_path_base + './outputs_pdb/ALK_9')  
    ...
    # Load vocab
    with open( '/data/guanlueli/1Data/1Data/data_ge/vocab_df_crossdock.pkl', 'rb') as f:
    ...
    # Load pocket
    data = pdb_to_pocket_data_ligand(args.pdb_path, args.mol_path, vocab, d=4)

    data = transform(data)

    args.result_path = os.path.join(args.result_path, os.path.splitext(os.path.basename(config.model.checkpoint))[0])
