...
class PocketLigandPairDataset(Dataset):
    ...
    def __init__(self, raw_path, transform=None, version='ph_v1'):  #m_v8_o
        super().__init__()
    ...
    def _connect_db(self):
        ...
        self.db = lmdb.open(
            self.processed_path,
            map_size=35 * (1024 * 1024 * 1024),  # 10GB
            create=False,
            subdir=False,
            readonly=True,
            lock=False,
        ...
        with db.begin(write=True, buffers=True) as txn:
            for i, (pocket_fn, ligand_fn, *_) in enumerate(tqdm(index)):
                ...
                try:
                    ...
                    ligand_path = os.path.join(self.protein_root, ligand_fn)
...
if __name__ == '__main__':
    ...
    dataset = PocketLigandPairDataset(args.path, version=args.version)
